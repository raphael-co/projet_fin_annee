...
const Delegate: FC = () => {
  ...
  return (
    <div className={`${styles.wrapper} delegate-wrapper`}>
      <Action
        title={translate('Delegate_Now', localStorage.getItem('langage'))}
        description={
          translate(
            'Delegate_Now_Description_Start',
        ...
        trigger={
          <div className={styles.trigger}>
            {' '}
            {translate('Delegate', localStorage.getItem('langage'))}
          </div>
        }
        render={

    ...
    <div className={`${styles.withdrawal} withdrawal`}>
      ...
      <div className={styles.right}>
        {counter > 0 && (
          <div className={styles.time}>
            ...
            <span className={styles.label}>
              {' '}
              {translate('Wait_Time_Left', localStorage.getItem('langage'))}t
            </span>
          </div>
        )}
        ...
        >
          ...
          <span> {translate('Withdraw', localStorage.getItem('langage'))}</span>
        </button>
      </div>
      ...
      {counter > 0 && (
        <div className={modifiable('time', ['mobile'], styles)}>
          ...
          <span className={styles.label}>
            {' '}
            {translate('Wait_Time_Left', localStorage.getItem('langage'))}
          </span>
        </div>
      )}
    </div>
